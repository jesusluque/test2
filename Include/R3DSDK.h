...
public:
	...
	// Turn off, or back on, Extended Highlights decoding for V-RAPTOR [X] clips
	// shot in this mode. Extended Highlights support is currently in BETA.
	...
	{
		FileTypeInvalid = 0,
		FileTypeR3D     = 1,	// Clip files
		FileTypeRMD     = 2,	// Sidecar overriding metadata
		FileTypeCube    = 3,	// 3D LUT with CUBE extension
		FileTypeCDL     = 4,	// Color Decision List sidecar
		FileTypeWAV		= 5		// BWF with WAV extension
	};
